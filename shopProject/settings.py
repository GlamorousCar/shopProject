...
DEBUG = socket.gethostname() != os.environ.get('PRODUCTION_SERVER')
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'Prynikvany@gmail.com'
DEFAULT_FROM_EMAIL = 'From Your Shop'
DEFAULT_TO_EMAIL = 'YaBoG228holodec@gmail.com'
